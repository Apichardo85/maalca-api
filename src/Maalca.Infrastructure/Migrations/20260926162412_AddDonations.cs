        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DonorEmail = table.Column<string>(type: "character varying(320)", maxLength: 320, nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Donations_Affiliates_AffiliateId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Donations_AffiliateId_Status_CreatedAt",
                table: "Donations",
                columns: new[] { "AffiliateId", "Status", "CreatedAt" });
        }
